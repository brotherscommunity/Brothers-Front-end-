  ...
  return (
    <section className="mt-16">
      ...
      <p className="mt-4 text-sm text-stone-700">
        {" "}
        Add and edit tags (not more than 5){" "}
      </p>
      ...
      {tags.length !== 5 && (
        <div className="flex flex-col justify-start gap-5 mt-10">
          <input
            ...
            className="w-[250px] rounded-md border border-gray-300 bg-button px-6 py-2.5 focus-visible:outline-none"
          />
          <button
            type="button"
            onClick={handleAddTag}
            className="mt-5 w-[150px] bg-navy rounded-md px-3 py-2 text-white max-sm:text-sm sm:text-base"
          >
            Add Tag
          </button>
        </div>
