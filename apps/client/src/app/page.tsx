      ...
      <div className="xl:mx-7 max-md:mt-8 md:mt-10 lg:mt-20 mb-28">
        <div className="w-full -ml-2 px-10 max-sm:py-3 sm:py-7 md:py-10 bg-button rounded-xl">
          <div className="border-none bg-navy rounded-md py-7">
            <span className="flex items-center justify-center text-white max-sm:text-lg sm:text-xl lg:text-3xl font-palanquin">
              {" "}
              Blog Posts{" "}
            </span>
          </div>
        ...
        <div className="mt-10">
          <Search
            queryParameter={QUERY_PARAMS.catagory}
